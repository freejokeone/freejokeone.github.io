...
module.exports = function(Chart) {
	...
	Chart.Legend = Chart.Element.extend({
		...
		handleEvent: function(e) {
			...
			if (x >= this.left && x <= this.right="" &&="" y="">= this.top && y <= this.bottom)="" {="" see="" if="" we="" are="" touching="" one="" of="" the="" dataset="" boxes="" var="" lh="this.legendHitBoxes;" for="" (var="" i="0;" <="" lh.length;="" ++i)="" hitbox="lh[i];" (x="">= hitBox.left && x <= hitbox.left="" +="" hitbox.width="" &&="" y="">= hitBox.top && y </=></=></=>